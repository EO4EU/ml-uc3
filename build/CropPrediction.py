                        ...
                        try:
                              ...
                              with cpOutput.joinpath('log.txt').open('w') as fileOutput:
                                    ...
                                    for csv_file in cp.rglob('*.csv'):
                                          ...
                                          logger_workflow.debug("gdf columns:", gdf.columns,extra={'status': 'DEBUG'})
                                          logger_workflow.debug("output columns:", output.columns, extra={'status': 'DEBUG'})
                                    ...
                                    "S3_bucket_desc": {
                                          "folder": "result-uc3-CropPrediction","filename": ""
                                    },
